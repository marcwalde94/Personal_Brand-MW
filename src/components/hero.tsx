...
export function Hero() {
  return (
    <section className="grain relative overflow-hidden">
      ...
      <div className="wrap relative z-10 grid min-h-[100svh] items-center gap-14 pt-28 pb-24 lg:grid-cols-[1.08fr_0.92fr] lg:gap-10 lg:pt-24">
        {/* Linke Spalte — Text */}
        <div>
          ...
          <h1
            className="intro mt-6 font-display text-[2.6rem] font-bold leading-[1.04] tracking-tight text-balance sm:text-6xl lg:text-[4.1rem]"
          ...
          <p
            className="intro mt-6 max-w-xl text-lg leading-relaxed text-muted text-pretty"
        ...
        {/* Rechte Spalte — Porträt */}
        <div
          className="intro relative mx-auto w-full max-w-[420px] lg:mx-0 lg:ml-auto"
        ...
        >
          ...
          <div className="absolute -right-2 top-7 rounded-xl px-3 py-2 glass shadow-lg shadow-black/30 sm:-right-5">
            ...
            <span className="mt-1 block text-[11px] text-muted">Digital Talent</span>
          </div>
        </div>
      </div>
